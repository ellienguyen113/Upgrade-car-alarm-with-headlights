...
/***Project Description***/ This project implements a car ignition and headlight control system that improves safety and ease of use for the driver. 
...
Ignition (table 1) and Headlight (table 2) Subsystems
